...
function Wiki() {
  ...
  useEffect(function () {
    var ws = new WebSocket("wss://".concat(window.location.host));
    ws.onmessage = function (event) {
      var data = JSON.parse(event.data);
      if (data.type === 'new_message') {
        setMessages(function (prev) {
          return [].concat(_toConsumableArray(prev), [data.data]).slice(-10);
        });
      }
    };
    return function () {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("nav", {
        ...
        className: "fixed bottom-4 right-4 w-64 bg-gray-800 rounded-lg p-4 shadow-lg",

...
`);
  ...
  function CheckoutPage() {
    const [nftData, setNftData] = (0, import_react4.useState)({
      name: "",
      image: "",
      description: "",
      emoji: "",
    ...
    const clientId = "ck_staging_21j2UbKYUM7wam4MbDspgk7E7XvnLGdf34YDrE67TFa5eMpBJNab8UCwLhPZFHjrUtUwy2N8x7uDCs6TKszdwHUAKoNzcKNk12drQQzCHuhQMniQdQPzReSat9sGr47Yk8mZnLy4bKe6tVmVP8khy2NdZpa2VUYPLRUHQ4KuLrNaj5VyGWyHSXdE4eGQ1LNpAXvsdfnn5u3dyTwBWuityYN";
    ...
    return /* @__PURE__ */ import_react4.default.createElement("div", { className: "min-h-screen bg-gradient-to-br from-gray-900 to-black text-white p-8" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "max-w-2xl mx-auto" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "bg-gray-800 rounded-lg shadow-xl p-6 mb-8" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "aspect-square w-64 h-64 mx-auto rounded-lg overflow-hidden mb-6" }, /* @__PURE__ */ import_react4.default.createElement(
      "img",
      {
        src: nftData.image,
        alt: nftData.name,
    ...
    )), /* @__PURE__ */ import_react4.default.createElement("h1", { className: "text-2xl font-bold mb-2 text-center" }, nftData.emoji, " ", nftData.name), /* @__PURE__ */ import_react4.default.createElement("p", { className: "text-gray-300 mb-4 text-center" }, nftData.description), nftData.personality && /* @__PURE__ */ import_react4.default.createElement("div", { className: "bg-gray-700 rounded p-4 mb-6" }, /* @__PURE__ */ import_react4.default.createElement("h2", { className: "text-lg font-semibold mb-2" }, "Personality"), /* @__PURE__ */ import_react4.default.createElement("p", { className: "text-gray-300" }, nftData.personality)), /* @__PURE__ */ import_react4.default.createElement("div", { className: "grid grid-cols-2 gap-4 mb-6" }, nftData.attributes?.map((attr, index) => /* @__PURE__ */ import_react4.default.createElement("div", { key: index, className: "bg-gray-700 rounded p-2" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "text-gray-400 text-sm" }, attr.trait_type), /* @__PURE__ */ import_react4.default.createElement("div", { className: "font-medium" }, attr.value)))), /* @__PURE__ */ import_react4.default.createElement("div", { className: "mt-6" }, /* @__PURE__ */ import_react4.default.createElement(J, { apiKey: clientId }, /* @__PURE__ */ import_react4.default.createElement(
      z2,
      {
        lineItems: {

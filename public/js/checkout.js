(() => {
  ...
  function CheckoutPage() {
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", { className: "flex min-h-screen items-center justify-center bg-gray-900" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "text-white text-xl" }, "Redirecting to checkout..."));
  }
  var root = document.getElementById("root");
  import_react_dom.default.render(/* @__PURE__ */ import_react.default.createElement(CheckoutPage, null), root);
})();

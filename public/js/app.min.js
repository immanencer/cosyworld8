...
function App() {
  ...
  const loadMoreAvatars = useCallback(async () => {
    ...
    if (activeTab === 'owned' && !(wallet !== null && wallet !== void 0 && wallet.publicKey)) return;
    setLoading(true);
    try {
      var _data$avatars;
      const endpoint = {
  ...
  }, [activeTab, wallet === null || wallet === void 0 ? void 0 : wallet.publicKey, loadMoreAvatars, resetState]);

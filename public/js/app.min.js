...
function App() {
  ...
  }, [activeTab, page, hasMore, wallet === null || wallet === void 0 ? void 0 : wallet.publicKey, loading]);
  useEffect(() => {
  ...
  }, [activeTab, wallet === null || wallet === void 0 ? void 0 : wallet.publicKey]); // Only depend on tab and wallet changes

  useEffect(() => {
    console.log("[Tab Change] Active Tab: ".concat(activeTab, ", Wallet Connected: ").concat(!!(wallet !== null && wallet !== void 0 && wallet.publicKey), ", Loading: ").concat(loading));
    if (loading) {
  ...
  }, [activeTab, wallet === null || wallet === void 0 ? void 0 : wallet.publicKey, loading]);

...
function LeaderboardView() {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _context7.prev = 0;
              _context7.next = 3;
              return fetch('/api/leaderboard/minted');
            case 3:
  ...
  }, "Score"))), /*#__PURE__*/React.createElement("tbody", null, leaderboard.map(function (avatar, index) {
...
function ViewToggle(_ref26) {
  var currentView = _ref26.currentView,
    onViewChange = _ref26.onViewChange;
  return /*#__PURE__*/React.createElement("div", {
    className: "flex justify-center gap-4 mb-8"
  }, /*#__PURE__*/React.createElement("button", {
    className: "px-4 py-2 rounded ".concat(currentView === 'collection' ? 'bg-blue-600 text-white' : 'bg-gray-700 text-gray-300'),
    onClick: function onClick() {
      return onViewChange('collection');
    }
  }, "Collection"), /*#__PURE__*/React.createElement("button", {
    className: "px-4 py-2 rounded ".concat(currentView === 'leaderboard' ? 'bg-purple-600 text-white' : 'bg-gray-700 text-gray-300'),
    onClick: function onClick() {
...
function TribesView(_ref28) {
  var onAvatarSelect = _ref28.onAvatarSelect;
  var _useState27 = useState([]),
    _useState28 = _slicedToArray(_useState27, 2),
    tribes = _useState28[0],
    setTribes = _useState28[1];
  ...
  var _useState31 = useState(null),
    ...
    selectedEmoji = _useState32[0],
    setSelectedEmoji = _useState32[1];
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 13:
              ...
              console.error('Error fetching tribes:', _context8.t0);
...
function BurnTokenButton(_ref30) {
  var wallet = _ref30.wallet,
  ...
  var handleBurn = /*#__PURE__*/function () {
    var _ref31 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
...
function WalletButton(_ref32) {
  var onWalletChange = _ref32.onWalletChange;
  var _useState39 = useState(null),
    _useState40 = _slicedToArray(_useState39, 2),
    wallet = _useState40[0],
    setWallet = _useState40[1];
  var _useState41 = useState(null),
    _useState42 = _slicedToArray(_useState41, 2),
    address = _useState42[0],
    setAddress = _useState42[1];
...
function App() {
  var _useState43 = useState([]),
    ...
    avatars = _useState44[0],
    setAvatars = _useState44[1];
  var _useState45 = useState(null),
    _useState46 = _slicedToArray(_useState45, 2),
    selectedAvatar = _useState46[0],
    setSelectedAvatar = _useState46[1];
  ...
  var _useState49 = useState(true),
    ...
    hasMore = _useState50[0],
    setHasMore = _useState50[1];
  var _useState51 = useState(null),
    _useState52 = _slicedToArray(_useState51, 2),
    lastMessageCount = _useState52[0],
    setLastMessageCount = _useState52[1];
  var _useState53 = useState(null),
    _useState54 = _slicedToArray(_useState53, 2),
    lastId = _useState54[0],
    setLastId = _useState54[1];
  var _useState55 = useState('All'),
    _useState56 = _slicedToArray(_useState55, 2),
    selectedTier = _useState56[0],
    setSelectedTier = _useState56[1];
  var _useState57 = useState('leaderboard'),
    _useState58 = _slicedToArray(_useState57, 2),
    currentView = _useState58[0],
    setCurrentView = _useState58[1];
  var _useState59 = useState(null),
    _useState60 = _slicedToArray(_useState59, 2),
    modalAvatar = _useState60[0],
    setModalAvatar = _useState60[1];
  var _useState61 = useState(null),
    _useState62 = _slicedToArray(_useState61, 2),
    wallet = _useState62[0],
    setWallet = _useState62[1];
  ...
  })) : currentView === 'leaderboard' ? /*#__PURE__*/React.createElement(LeaderboardView, null) : currentView === 'combat' ? /*#__PURE__*/React.createElement(CombatLog, {
...
function AvatarGallery() {
  var _useState63 = useState([]),
    ...
    avatars = _useState64[0],
    setAvatars = _useState64[1];
  var _useState65 = useState(null),
    _useState66 = _slicedToArray(_useState65, 2),
    publicKey = _useState66[0],
    setPublicKey = _useState66[1];
  ...
  var loadAvatars = /*#__PURE__*/function () {
    var _ref37 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee14() {
      var response, data;

...
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; } // Ensure marked is installed via npm
// Assume you have some basic styles
/** Utility Functions **/ // Sanitize number input
...
var MarkdownContent = function MarkdownContent(_ref) {
  ...
  var sanitizedContent = (0, _marked.marked)(content || '').replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, '');
...
var TierBadge = /*#__PURE__*/_react["default"].memo(function (_ref2) {
  var tier = _ref2.tier;
  var colors = {
    S: 'bg-purple-600',
    // Legendary
...
var TierFilter = /*#__PURE__*/_react["default"].memo(function (_ref4) {
...
var ActivityFeed = function ActivityFeed(_ref5) {
  ...
  var activities = _react["default"].useMemo(function () {
...
var AncestryChain = /*#__PURE__*/_react["default"].memo(function (_ref6) {
...
var StatsDisplay = /*#__PURE__*/_react["default"].memo(function (_ref7) {
...
var XAuthButton = function XAuthButton(_ref9) {
  ...
  var checkAuthStatus = (0, _react.useCallback)(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, data;
...
var AvatarDetailModal = function AvatarDetailModal(_ref14) {
  ...
  // Slide Component
  var VariantSlide = /*#__PURE__*/_react["default"].memo(function (_ref17) {
...
var AvatarCard = /*#__PURE__*/_react["default"].memo(function (_ref18) {
...
var AvatarSearch = /*#__PURE__*/_react["default"].memo(function (_ref19) {
...
var CombatLogEntry = /*#__PURE__*/_react["default"].memo(function (_ref21) {
...
var CombatLog = /*#__PURE__*/_react["default"].memo(function (_ref23) {
...
var LeaderboardView = /*#__PURE__*/_react["default"].memo(function () {
...
var ViewToggle = /*#__PURE__*/_react["default"].memo(function (_ref26) {
...
var FamilyCard = /*#__PURE__*/_react["default"].memo(function (_ref27) {
...
var TribesView = /*#__PURE__*/_react["default"].memo(function (_ref28) {
  ...
  var sanitizeMembers = (0, _react.useCallback)(function (members) {
  ...
  var sanitizeTribe = (0, _react.useCallback)(function (tribe) {
  ...
  var fetchTribeDetails = (0, _react.useCallback)(/*#__PURE__*/function () {
...
var BurnTokenButton = /*#__PURE__*/_react["default"].memo(function (_ref31) {
...
var WalletButton = /*#__PURE__*/_react["default"].memo(function (_ref33) {
  ...
  var connectWallet = (0, _react.useCallback)(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
    var isMobile, resp;
...
var App = function App() {
  ...
  var _useState61 = (0, _react.useState)('All'),
    _useState62 = _slicedToArray(_useState61, 2),
    selectedTier = _useState62[0],
    setSelectedTier = _useState62[1];
  var _useState63 = (0, _react.useState)('leaderboard'),
  ...
  var loadAvatars = (0, _react.useCallback)(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee12() {
    var isInitial,
      url,
      res,
      data,
  ...
  var handleAvatarSelect = (0, _react.useCallback)(function (avatar) {
...
_client["default"].createRoot(rootElement).render(/*#__PURE__*/(0, _jsxRuntime.jsx)(App, {}));

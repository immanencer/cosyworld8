...
function MarkdownContent(_ref) {
  ...
  var sanitizedContent = marked.parse(content || '').replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, '');
...
function TierBadge(_ref2) {
  ...
  var colors = {
    S: 'bg-purple-600',
    // matches legendary: 0x9333EA
    A: 'bg-blue-600',
    // matches rare: 0x2563EB
    B: 'bg-green-600',
    // matches uncommon: 0x16A34A
    C: 'bg-yellow-600',
    // matches common: 0xEAB308
...
function ActivityFeed(_ref5) {
  ...
  var activities = [].concat(_toConsumableArray(messagesList.map(function (m) {
    return {
      type: 'message',
      content: m.content,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, activity.icon), /*#__PURE__*/React.createElement("span", {
      className: "text-xs text-gray-500"
    }, formatDate(activity.timestamp)), /*#__PURE__*/React.createElement("span", {
      className: "text-xs text-gray-400 ml-auto"
    }, activity.type)), /*#__PURE__*/React.createElement(MarkdownContent, {
...
function AncestryChain(_ref6) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, ancestry.slice().reverse().map(function (ancestor, index, array) {
    ...
    }, ancestor.name), /*#__PURE__*/React.createElement("div", {
      className: "text-gray-400 text-xs"
    }, ancestor.emoji))), index < array.length - 1 && /*#__PURE__*/React.createElement("span", {
...
function StatsDisplay(_ref7) {
  ...
  if (size === "small") {
    ...
    }, hp > 0 && /*#__PURE__*/React.createElement("span", {
      title: "HP"
    }, "\u2764\uFE0F ", hp), attack > 0 && /*#__PURE__*/React.createElement("span", {
      title: "Attack"
    }, "\u2694\uFE0F ", attack), defense > 0 && /*#__PURE__*/React.createElement("span", {
      title: "Defense"
    }, "\uD83D\uDEE1\uFE0F ", defense));
  }
  return /*#__PURE__*/React.createElement("div", {
    className: "space-y-4"
  }, hp > 0 && /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-sm text-gray-400"
  }, "Attack"), /*#__PURE__*/React.createElement("div", {
    className: "text-xl"
  }, "\u2694\uFE0F ", attack)), /*#__PURE__*/React.createElement("div", {
    className: "bg-gray-800 rounded p-2"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-sm text-gray-400"
  }, "Defense"), /*#__PURE__*/React.createElement("div", {
    className: "text-xl"
  }, "\uD83D\uDEE1\uFE0F ", defense))));
}
var XAuthButton = function XAuthButton(_ref9) {
  ...
  var handleAuth = /*#__PURE__*/function () {
    var _ref11 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var response, _yield$response$json, url, _error, popup, handleMessage, checkClosed;
  ...
  if (loading) {
    ...
    }), /*#__PURE__*/React.createElement("span", null, "Checking status..."));
  }
  if (error) {
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "\u26A0\uFE0F ", /*#__PURE__*/React.createElement("span", null, "Retry connection")), /*#__PURE__*/React.createElement("p", {
  ...
  if (authStatus !== null && authStatus !== void 0 && authStatus.authorized) {
    ...
    }, "\uD835\uDD4F ", /*#__PURE__*/React.createElement("span", null, "Connected")), /*#__PURE__*/React.createElement("button", {
  ...
  }, "\uD835\uDD4F ", /*#__PURE__*/React.createElement("span", null, "Connect X Account"));
};

// Update the modal layout
function AvatarDetailModal(_ref14) {
  ...
  }, [avatar === null || avatar === void 0 ? void 0 : avatar._id]);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    tier: tier
  }), avatar.model && /*#__PURE__*/React.createElement("span", null, avatar.model), avatar.emoji && /*#__PURE__*/React.createElement("span", null, avatar.emoji)))), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    className: "text-gray-400 hover:text-white text-2xl"
  }, "\xD7")), /*#__PURE__*/React.createElement(AncestryChain, {
    ...
    return /*#__PURE__*/React.createElement(VariantSlide, {
      key: idx,
      variant: variant,
      active: idx === currentVariantIndex
    });
  }), variants.length > 1 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2 z-10"
  }, variants.map(function (_, idx) {
    return /*#__PURE__*/React.createElement("button", {
      key: idx,
    ...
    }), variant.dynamicPersonality && /*#__PURE__*/React.createElement("div", {
      className: "mt-4 text-gray-400"
    }, /*#__PURE__*/React.createElement("h4", {
      className: "font-bold mb-1"
    }, "Personality"), /*#__PURE__*/React.createElement(MarkdownContent, {
...
function AvatarCard(_ref18) {
  ...
  }), allAvatars.length > 1 && /*#__PURE__*/React.createElement("span", {
    className: "absolute top-1 right-1 bg-blue-500 text-xs rounded-full w-5 h-5 flex items-center justify-center"
  }, allAvatars.length)), /*#__PURE__*/React.createElement("div", {
    className: "space-y-1"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-1 justify-between"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-bold truncate"
  }, avatar.name), /*#__PURE__*/React.createElement(TierBadge, {
    tier: tier
  })), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-1 text-xs text-gray-400"
  }, /*#__PURE__*/React.createElement("span", null, "\u2709\uFE0F ", avatar.messageCount)), /*#__PURE__*/React.createElement(StatsDisplay, {
    stats: avatar.stats,
    size: "small"
  })));
}
...
function AvatarSearch(_ref19) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "font-medium"
    }, avatar.name), avatar.emoji && /*#__PURE__*/React.createElement("div", {
      className: "text-sm text-gray-400"
    }, avatar.emoji)));
  })));
}
...
function CombatLogEntry(_ref21) {
  ...
  var CombatantDisplay = function CombatantDisplay(_ref22) {
    ...
    }, emoji || '👤')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    ...
    }, name), emoji && /*#__PURE__*/React.createElement("div", {
      className: "text-xs text-gray-400"
    }, emoji)));
  };
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(CombatantDisplay, {
  ...
  }, entry.result.substring(0, 80))), entry.targetName && /*#__PURE__*/React.createElement(CombatantDisplay, {
...
function CombatLog(_ref23) {
  ...
  }, "Recent Combat Actions"), /*#__PURE__*/React.createElement("div", {
    className: "space-y-4 max-w-3xl mx-auto"
  }, combatLog.map(function (entry, index) {
    return /*#__PURE__*/React.createElement(CombatLogEntry, {
      key: index,
      entry: entry,
      onAvatarClick: onAvatarSelect
    });
  }), combatLog.length === 0 && /*#__PURE__*/React.createElement("div", {
    className: "text-center py-8 text-gray-500"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-4xl mb-2"
  }, "\u2694\uFE0F"), /*#__PURE__*/React.createElement("div", null, "No combat actions yet"))));
}
function ViewToggle(_ref25) {
  var currentView = _ref25.currentView,
    onViewChange = _ref25.onViewChange;
  return /*#__PURE__*/React.createElement("div", {
    className: "flex justify-center gap-4 mb-8"
  }, /*#__PURE__*/React.createElement("button", {
    className: "px-4 py-2 rounded ".concat(currentView === 'leaderboard' ? 'bg-blue-600 text-white' : 'bg-gray-700 text-gray-300'),
    onClick: function onClick() {
      return onViewChange('leaderboard');
    }
  }, "Leaderboard"), /*#__PURE__*/React.createElement("button", {
    className: "px-4 py-2 rounded ".concat(currentView === 'combat' ? 'bg-red-600 text-white' : 'bg-gray-700 text-gray-300'),
    onClick: function onClick() {
      return onViewChange('combat');
    }
  }, "Combat Log"), /*#__PURE__*/React.createElement("button", {
    className: "px-4 py-2 rounded ".concat(currentView === 'tribes' ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300'),
    onClick: function onClick() {
      return onViewChange('tribes');
    }
  }, "Tribes"));
}
function FamilyCard(_ref26) {
  var family = _ref26.family,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-2xl"
  }, family.emoji), /*#__PURE__*/React.createElement("div", {
...
function TribesView(_ref27) {
  var onAvatarSelect = _ref27.onAvatarSelect;
  var _useState23 = useState([]),
    _useState24 = _slicedToArray(_useState23, 2),
    tribes = _useState24[0],
    setTribes = _useState24[1];
  ...
  var _useState27 = useState(null),
    ...
    selectedEmoji = _useState28[0],
    setSelectedEmoji = _useState28[1];
  ...
  useEffect(function () {
    var fetchTribes = /*#__PURE__*/function () {
      var _ref28 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        var response, data, validTribes;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _context7.prev = 0;
              _context7.next = 3;
              return fetch('/api/tribes');
            case 3:
            ...
            case 8:
              ...
              validTribes = (Array.isArray(data) ? data : []).map(sanitizeTribe).filter(Boolean);
            ...
            case 13:
              ...
              console.error('Error fetching tribes:', _context7.t0);
  ...
  var selectedTribe = selectedEmoji ? tribes.find(function (t) {
    return t && t.emoji === selectedEmoji;
  }) : null;
  console.log('selectedTribe', selectedTribe);
  console.log('selectedTribe.emoji', selectedTribe === null || selectedTribe === void 0 ? void 0 : selectedTribe.emoji);
  console.log('members', selectedTribe === null || selectedTribe === void 0 ? void 0 : selectedTribe.members);
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap gap-4 mb-8 justify-center"
  }, tribes.map(function (tribe) {
    return /*#__PURE__*/React.createElement("button", {
      key: tribe.emoji,
      onClick: function onClick() {
      ...
      className: "text-2xl"
    }, tribe.emoji), /*#__PURE__*/React.createElement("span", {
      className: "text-sm font-medium"
    }, tribe.count));
  })), selectedTribe && /*#__PURE__*/React.createElement("div", {
    className: "bg-gray-800 rounded-lg p-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-4 mb-6"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-4xl"
  }, selectedTribe.emoji), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-bold"
  }, selectedTribe.count, " Members"), /*#__PURE__*/React.createElement("p", {
    className: "text-gray-400"
  }, "Click an avatar to view details"))), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4"
  }, selectedTribe.members.map(function (member) {
    return /*#__PURE__*/React.createElement("div", {
      key: member._id,
      onClick: function onClick() {
    ...
    }, member.name), member.model && /*#__PURE__*/React.createElement("div", {
      className: "text-xs text-gray-400"
    }, member.model), member.emoji && /*#__PURE__*/React.createElement("div", {
      className: "text-sm"
    }, member.emoji)));
  }))), !selectedTribe && /*#__PURE__*/React.createElement("div", {
...
function BurnTokenButton(_ref29) {
  var wallet = _ref29.wallet,
  ...
  var handleBurn = /*#__PURE__*/function () {
    var _ref30 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
  ...
  }), "Burning...") : 'Burn 1000 Tokens for Random NFT', error && /*#__PURE__*/React.createElement("div", {
    className: "text-red-500 text-sm mt-2"
  }, error));
}
function WalletButton(_ref31) {
  var onWalletChange = _ref31.onWalletChange;
  var _useState35 = useState(null),
    _useState36 = _slicedToArray(_useState35, 2),
    wallet = _useState36[0],
    setWallet = _useState36[1];
  ...
  var disconnectWallet = function disconnectWallet() {
    if (wallet) {
      ...
      setWallet(null);
      setAddress(null);
      onWalletChange === null || onWalletChange === void 0 || onWalletChange(null); // Notify parent of wallet disconnection
    }
  };
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Connect Wallet")) : /*#__PURE__*/React.createElement("button", {
    onClick: disconnectWallet,
    className: "bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-lg flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "truncate w-32"
  }, address), /*#__PURE__*/React.createElement("span", null, "\xD7")));
}
...
function App() {
  var _useState39 = useState([]),
    ...
    avatars = _useState40[0],
    setAvatars = _useState40[1];
  var _useState41 = useState(null),
    _useState42 = _slicedToArray(_useState41, 2),
    selectedAvatar = _useState42[0],
    setSelectedAvatar = _useState42[1];
  ...
  var _useState45 = useState(true),
    ...
    hasMore = _useState46[0],
    setHasMore = _useState46[1];
  var _useState47 = useState(null),
    _useState48 = _slicedToArray(_useState47, 2),
    lastMessageCount = _useState48[0],
    setLastMessageCount = _useState48[1];
  var _useState49 = useState(null),
    _useState50 = _slicedToArray(_useState49, 2),
    lastId = _useState50[0],
    setLastId = _useState50[1];
  var _useState51 = useState('All'),
    _useState52 = _slicedToArray(_useState51, 2),
    selectedTier = _useState52[0],
    setSelectedTier = _useState52[1];
  var _useState53 = useState('leaderboard'),
    _useState54 = _slicedToArray(_useState53, 2),
    currentView = _useState54[0],
    setCurrentView = _useState54[1];
  var _useState55 = useState(null),
    _useState56 = _slicedToArray(_useState55, 2),
    modalAvatar = _useState56[0],
    setModalAvatar = _useState56[1];
  ...
  var handleAvatarSelect = function handleAvatarSelect(avatar) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Avatar Dashboard"), /*#__PURE__*/React.createElement(ViewToggle, {
    currentView: currentView,
    onViewChange: setCurrentView
  }), currentView === 'leaderboard' ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TierFilter, {
    selectedTier: selectedTier,
    onTierChange: function onTierChange(tier) {
    ...
    className: "animate-spin rounded-full h-8 w-8 border-b-2 border-white mx-auto"
  })), selectedAvatar && /*#__PURE__*/React.createElement(AvatarDetailModal, {
    avatar: selectedAvatar,
    onClose: function onClose() {
      return setSelectedAvatar(null);
    }
  })) : currentView === 'combat' ? /*#__PURE__*/React.createElement(CombatLog, {
    onAvatarSelect: handleAvatarSelect
  }) : /*#__PURE__*/React.createElement(TribesView, {
    onAvatarSelect: handleAvatarSelect
  }), modalAvatar && /*#__PURE__*/React.createElement(AvatarDetailModal, {
    avatar: modalAvatar,
    onClose: function onClose() {
...
function AvatarGallery() {
  var _useState59 = useState([]),
    ...
    avatars = _useState60[0],
    setAvatars = _useState60[1];
  var _useState61 = useState(null),
    _useState62 = _slicedToArray(_useState61, 2),
    publicKey = _useState62[0],
    setPublicKey = _useState62[1];
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-48 h-48 bg-wood-pattern rounded-lg mb-4"
  }), /*#__PURE__*/React.createElement("button", {
    onClick: mintAvatar,
    className: "px-6 py-3 bg-green-600 rounded-lg hover:bg-green-700"
  }, "Mint New Avatar"))));
}
ReactDOM.createRoot(document.getElementById('root')).render(/*#__PURE__*/React.createElement(AvatarGallery, null));